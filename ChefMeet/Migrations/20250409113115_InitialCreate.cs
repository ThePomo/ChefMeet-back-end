        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Specialità = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Creazioni", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreazioneId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Likes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Likes_AspNetUsers_UtenteId",
                        column: x => x.UtenteId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Likes_Creazioni_CreazioneId",
                        column: x => x.CreazioneId,
                        principalTable: "Creazioni",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Prenotazioni_AspNetUsers_UtenteId",
                        column: x => x.UtenteId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Creazioni_ChefId",
                table: "Creazioni",
                column: "ChefId");

            migrationBuilder.CreateIndex(
                name: "IX_Eventi_ChefId",
                table: "Eventi",
                column: "ChefId");

            migrationBuilder.CreateIndex(
                name: "IX_Likes_CreazioneId",
                table: "Likes",
                column: "CreazioneId");

            migrationBuilder.CreateIndex(
                name: "IX_Likes_UtenteId",
                table: "Likes",
                column: "UtenteId");
